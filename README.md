...
02.01.2022 was added ability to start UI tests in container with different browsers using Selenoid.
...
If you want to start tests without selenoid, you can skip steps 1-5 and comment @BeforeClass
